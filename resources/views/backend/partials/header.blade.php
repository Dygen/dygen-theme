<header id="header" class="clearfix" data-current-skin="blue">
    <a href="{{ url('admin') }}"><img src="{{ asset('/images/logo.png') }}" class="cl-center" style="width: 200px"></a>
    <ul class="header-inner">
        ...
        <li class="logo">
            <a href="{{ url('admin') }}"><img src="{{ asset('/images/logo.png') }}" class="cl hidden-xs" style="width: 200px"></a>
        </li>
        <li class="pull-right">
            <ul class="top-menu">
                <li id="top-search">
